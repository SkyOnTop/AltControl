...
local ScriptName = "Ticxyy Stand LEAKS"
...
Notify({Title = ScriptName.." Loaded",Description ="Skid it if you want",Duration = 3.4028235e+38})
Notify({Title = "Hello there :3",Description ="Made By Ticxyylolz#9164",Duration = 3.4028235e+38})
function output(plr, msg)
    Notify({Title = plr.Name.. ": ".. msg ,Duration = 8})
end
